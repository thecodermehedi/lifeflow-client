...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="border-b w-full md:block md:text-sm md:border-none fixed top-0 z-[9999] bg-white">
              ...
              {navigation.map((item, idx) => {
                return (
                  <NavLink
                    ...
                    className={({isActive}) =>
                      isActive
                        ? "block py-3 px-4 border rounded-lg bg-base w-full md:w-fit"
                        : "block py-3 px-4 border rounded-lg btn-hover w-full md:w-fit"
                    }
                  >
